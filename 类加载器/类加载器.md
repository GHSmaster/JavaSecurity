...
参考资料：《深入理解java虚拟机》第七章，虚拟机类加载机制在Java基础面向对象部分，较为深入的学习了类和对象相关的知识，描述了Class中成员变量成员方法的信息，在Java的机制中，Class中的这些信息只有被加载到虚拟机之后才能够被运行和使用，而类加载器就是Java虚拟机中的类加载机制，我们通过本部分的学习来详细了解这个机制。
